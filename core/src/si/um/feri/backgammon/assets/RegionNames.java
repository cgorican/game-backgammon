...
public class RegionNames {
    ...
    public static final String DICE_3 = "dice-val-3";
    public static final String DICE_4 = "dice-val-4";
    public static final String DICE_5 = "dice-val-5";
    public static final String DICE_6 = "dice-val-6";
